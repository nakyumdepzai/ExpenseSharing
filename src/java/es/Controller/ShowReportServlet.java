...
import es.Model.reportDAO;
import es.Model.reportDTO;
 ...
 */
@WebServlet(name = "ShowReportServlet", urlPatterns = {"/ShowReportServlet"})
public class ShowReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.showReportInfo();
            List<reportDTO> reportResult = dao.getReports();
            request.setAttribute("REPORT_RESULT", reportResult);
